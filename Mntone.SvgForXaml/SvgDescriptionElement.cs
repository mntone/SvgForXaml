...
{
	public sealed class SvgDescriptionElement : SvgElement, ISvgStylable
	{
		internal SvgDescriptionElement(INode parent, XmlElement element)
			: base(parent, element)
		{
		...
		{
			var casted = (SvgDescriptionElement)element;
			casted._stylableHelper = this._stylableHelper.DeepCopy(casted);
		}

		public override string TagName => "desc";
